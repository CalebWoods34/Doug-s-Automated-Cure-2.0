...
Public Class FrmPumpBackupReporting
    ...
    Private Sub FrmBackupReporting_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub FrmBackupReporting_Closing() '''''''''''''''''''FIGURE CLOSING OUT
        Me.Dispose()
        'GC.Collect()
    ...
    Private Sub frmBackupReporting_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        Me.Dispose()
        'GC.Collect()
        'GC.WaitForPendingFinalizers()
        'GC.Collect()
